...
=== RankingService
Define la lógica necesaria para la valoración y bonificiación de conductores y usuarios.

Por ejemplo, un conductor rebibe puntos/bonificación por haber devuelto la documentación a un cliente que notificó a Atención al Cliente haberla olvidado en el vehículo.
...
Se permite un fitro sencillo con rango de fechas.
...
. [red]#TODO:# Si se ha concluído el trayecto satisfactoriamente se emite factura del precio aplicado al perfil del cliente y dependiendo del perfil del vehículo elegido (TODO)
