...
=== FareService
Define las políticas necesarias para cancelar el trayecto y emitir la factura.

=== LocatorService
Define las políticas necesarias para localizar los vehículos.
...
. Si se ha concluído el trayecto satisfactoriamente se emite factura la del cliente dependiendo del vehículo elegido
