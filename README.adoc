...
[link=https://travis-ci.org/butcherless/boot-cantaloupe]
image:https://travis-ci.org/butcherless/boot-cantaloupe.svg?branch=master[] -> master

[link=https://travis-ci.org/butcherless/boot-cantaloupe]
image:https://travis-ci.org/butcherless/boot-cantaloupe.svg?branch=pruebas-manu[] -> pruebas-manu
